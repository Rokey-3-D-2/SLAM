...
class YoloDepthToMap(Node):
    ...
    def publish_error(self, base: dict, obj: dict, label: str, img):
        ...
        self.get_logger().info("4444444  publish done  44444444")
    ...
    def inference_callback(self):
        ...
        for result in results:
            ...
            for box in result.boxes:
                ...
                #     continue
                self.get_logger().info("3333333333  image found  333333333")
                ...
                if "err" in label:
                    self.get_logger().info("111111111  error found  111111111")
                    # base_link 기준 포인트 생성
                    base = PointStamped()
                    ...
                    self.get_logger().info("22222  error found  2222")
